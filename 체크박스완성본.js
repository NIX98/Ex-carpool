  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        <Checkbox style={styles.checkbox} value={isCarChecked} onValueChange={setCarChecked} />
        <Text style={styles.paragraph}>카풀</Text> 
        <Checkbox style={styles.checkbox} value={isTaxiChecked} onValueChange={setTaxiChecked} />
